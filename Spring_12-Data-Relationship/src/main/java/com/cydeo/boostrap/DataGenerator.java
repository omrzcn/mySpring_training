...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        paymentRepository.delete(payment1);  // its deleted from paymentTable but its still on payment_detail table because of CASCADE.PERSIST and CASCADE.MERGE... BUT we dont use this cascade in companies.
